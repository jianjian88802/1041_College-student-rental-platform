<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="平方数" prop="pingfangshu">
          <el-input v-model="ruleForm.pingfangshu" 
              placeholder="平方数" clearable  :readonly="ro.pingfangshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="平方数" prop="pingfangshu">
              <el-input v-model="ruleForm.pingfangshu" 
                placeholder="平方数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="出租类型" prop="chuzuleixing">
          <el-select v-model="ruleForm.chuzuleixing" placeholder="请选择出租类型">
            <el-option
                v-for="(item,index) in chuzuleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="出租类型" prop="chuzuleixing">
	      <el-input v-model="ruleForm.chuzuleixing"
                placeholder="出租类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="装修情况" prop="zhuangxiuqingkuang">
          <el-select v-model="ruleForm.zhuangxiuqingkuang" placeholder="请选择装修情况">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="装修情况" prop="zhuangxiuqingkuang">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="其它信息" prop="qitaxinxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="其它信息"
                  v-model="ruleForm.qitaxinxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qitaxinxi" label="其它信息" prop="qitaxinxi">
                    <span>{{ruleForm.qitaxinxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huxing = true;
          ...
          if(o=='pingfangshu'){
            this.ruleForm.pingfangshu = obj[o];
	    this.ro.pingfangshu = true;
            continue;
          }
          if(o=='weizhi'){
	    ...
	    this.ro.xiangguantupian = true;
          ...
          if(o=='chuzuleixing'){
            this.ruleForm.chuzuleixing = obj[o];
	    this.ro.chuzuleixing = true;
            continue;
          }
          if(o=='zujin'){
	    ...
	    this.ro.zhuangxiuqingkuang = true;
          ...
          if(o=='qitaxinxi'){
            this.ruleForm.qitaxinxi = obj[o];
	    this.ro.qitaxinxi = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.zhuangxiuqingkuangOptions = "一般,豪华,精装".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
